...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        closestGhostPos = min(mostLikelyGhostPositions, key=lambda pos: self.distancer.getDistance(pos, pacmanPosition))
        bestAction = min(legal, key=lambda action: self.distancer.getDistance(closestGhostPos, Actions.getSuccessor(pacmanPosition, action)))
        return bestAction
        "*** END YOUR CODE HERE ***"
