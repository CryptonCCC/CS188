...
class PerceptronModel(Module):
    def __init__(self, dimensions):
        ...
        "*** YOUR CODE HERE ***"
        weight = Parameter(ones((1, dimensions)))
        self.w = weight #Initialize your weights here
        ...
        with no_grad():
            ...
            while True:
                ...
                for sample in dataloader:
                    if self.get_prediction(sample['x']) != sample['label']:
...
class RegressionModel(Module):
    ...
    def __init__(self):
        ...
        #parameters to learn
        self.layer1 = Linear(1, layer_size)
        self.layer2 = Linear(layer_size, layer_size)
        self.layer3 = Linear(layer_size, 1)
    ...
    def train(self, dataset):
        ...
        while True:
            total_train_loss, num_batch = 0, 0
...
class DigitClassificationModel(Module):
    ...
    def __init__(self):
        ...
        #parameters to learn
        self.layer1 = Linear(input_size, layer_size1)
        self.layer2 = Linear(layer_size1, layer_size2)
        self.layer3 = Linear(layer_size2, output_size)
...
class LanguageIDModel(Module):
    ...
    def train(self, dataset):
        ...
        while True:
            ...
            for batch in dataloader:
                optimizer.zero_grad()
                #print(movedim(batch['x'], 1, 0).shape)
                #print(batch['x'].shape)
                loss = self.get_loss(movedim(batch['x'], 1, 0), batch['label'])
                loss.backward()
                optimizer.step()
